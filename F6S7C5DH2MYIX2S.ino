...
int LDRMin = 0;  // minimum sensor value
int LDRMax = 1023;     // maximum sensor value
...
void loop() {
  ...
  LDRValue = map(LDRValue, 100, 950, 0, 1023);
...
if(digitalRead(4)==LOW){
  Serial.print("A5 LDRValue - ");
  Serial.println(LDRValue);
  Serial.print("A4 syncPhaseInc - ");
  Serial.println(syncPhaseInc);
  Serial.print("A3 grainPhaseInc - ");
  Serial.println(grainPhaseInc);
    Serial.print("A2 grainDecay - ");
  Serial.println(grainDecay);
    Serial.print("A1 grain2PhaseInc - ");
  Serial.println(grain2PhaseInc);
    Serial.print("A0 grain2Decay - ");
